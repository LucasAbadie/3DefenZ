	...
	public class EnemyBase : MonoBehaviour
	{
		...
		*/
		public float Health
		{
			...
			set
			{
				...
				health = value;
				healthBar.fillAmount = Tools.MathMethods.GetPercent(health, 0, healthMax, 0, 1);
			}
		}
		...
		*/
		...
		public void Kill()
		{
			...
			if (levelManager.WaveSpawner.Enemies.Contains(this.transform.parent.gameObject))
			{
				levelManager.WaveSpawner.Enemies.Remove(this.transform.parent.gameObject);
			}
